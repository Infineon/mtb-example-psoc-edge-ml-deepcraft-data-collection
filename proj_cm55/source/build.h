...
*
* Description:
*   This file contains macros to compute the build date and time using the
*   predefined macros __DATE__ and __TIME__.
*
...
#define BUILD_DATE (BUILD_YEAR*10000 + BUILD_MONTH*100 + BUILD_DAY)
...
#define BUILD_TIME (BUILD_HOUR*10000 + BUILD_MIN*100 + BUILD_SEC)
